...
krho = Cheshev_interpolation(0:0.01:30);
n = 20;
...
name  = char('Value','spline','GL','splineGL','Glag','Adapt','Romberg');
E_phi = [E_phi_Value,E_phi_spline,E_phi_GL,E_phi_splineGL,E_phi_Glag,E_phi_Adapt,E_phi_Romberg];
H_rho = [H_rho_Value,H_rho_spline,H_rho_GL,H_rho_splineGL,H_rho_Glag,H_rho_Adapt,H_rho_Romberg];
H_z = [H_z_Value,H_z_spline,H_z_GL,H_z_splineGL,H_z_Glag,H_z_Adapt,H_z_Romberg];
